...
const roleOutputKey = "GitHubFrontendReleaseRoleArn";
const roleSecretName = "LIGHTNING_GITHUB_ACTIONS_ROLE_ARN_FRONTEND_RELEASE";
...
main().catch((error) => {
  console.error("Frontend release GitHub secret sync failed:", error);
  process.exitCode = 1;
});
