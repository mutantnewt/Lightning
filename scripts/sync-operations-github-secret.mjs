...
const roleOutputKey = "GitHubOperationsReadRoleArn";
const roleSecretName = "LIGHTNING_GITHUB_ACTIONS_ROLE_ARN_OPERATIONS";
...
main().catch((error) => {
  console.error("Operations GitHub secret sync failed:", error);
  process.exitCode = 1;
});
